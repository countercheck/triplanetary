...
beforeAll(async () => {
  ...
  await supertest(server)
    ...
    .send({ email: 'mapeditor-admin@test.com', password: 'pass', displayName: 'Admin' });
  ...
  await supertest(server)
    .post('/api/auth/register')
    .send({ email: 'mapeditor-user@test.com', password: 'pass', displayName: 'User' });
...
describe('GET /api/maps/:id', () => {
  ...
  it('returns 404 for unknown id', async () => {
    const res = await userAgent.get('/api/maps/00000000-0000-0000-0000-000000000000');
